ARG VER=latest
FROM ramirezfx/kubuntu-baseimage:$VER
ENV SHELL=/bin/bash
...
RUN wget -O /tmp/languages.txt https://github.com/ramirezfx/kubuntu-desktop/raw/main/languages.txt && xargs -a /tmp/languages.txt apt-get install -y
